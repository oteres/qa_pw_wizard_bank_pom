...
test('Assert manager can choose currencies for account', async ({ page }) => {
  ...
  */
  ...
  await openAccountPage.assertCurrencyDropdownHaveValue('Dollar');
  await openAccountPage.selectCurrency('Pound');
  await openAccountPage.assertCurrencyDropdownHaveValue('Pound');
  await openAccountPage.selectCurrency('Rupee');
  await openAccountPage.assertCurrencyDropdownHaveValue('Rupee');
});
